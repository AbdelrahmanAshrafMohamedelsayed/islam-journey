...
export function AudioPlayer({
  ...
  const waveformHeights = [
    ["30%", "70%", "45%"], ["55%", "35%", "65%"], ["40%", "80%", "50%"],
    ["65%", "40%", "75%"], ["50%", "60%", "35%"], ["75%", "45%", "70%"],
    ["35%", "75%", "55%"], ["60%", "30%", "65%"], ["45%", "70%", "40%"],
    ["70%", "50%", "80%"], ["55%", "65%", "45%"], ["80%", "40%", "60%"],
    ["40%", "55%", "70%"], ["65%", "75%", "35%"], ["50%", "45%", "75%"],
    ["75%", "60%", "50%"], ["35%", "80%", "65%"], ["60%", "35%", "55%"],
    ["45%", "65%", "80%"], ["70%", "50%", "40%"],
  ];
