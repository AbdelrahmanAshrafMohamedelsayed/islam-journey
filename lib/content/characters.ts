...
export interface CharacterUnlockCondition {
  type: "default" | "chapter_complete" | "lessons_complete" | "streak" | "level";
...
export interface CharacterDialogue {
  ...
  context?: "intro" | "explanation" | "question" | "encouragement" | "celebration" | "farewell";
}
...
export function getAllCharacters(): Character[] {
  return [...Object.values(CHARACTERS), ...Object.values(HISTORICAL_CHARACTERS)];
}
...
export function checkCharacterUnlock(
  ...
  switch (unlockCondition.type) {
    ...
    case "chapter_complete":
      return userProgress.completedChapters.includes(unlockCondition.value as string);
